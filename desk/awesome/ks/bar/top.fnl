...
(fn attach [screen]
  ...
  (bar:setup (ks.container wibox.layout.align.horizontal
                           (ks.container wibox.layout.fixed.horizontal
                                         (awful.widget.taglist {: screen
                                                                :filter awful.widget.taglist.filter.all
                                                                :widget_template (ks.widget wibox.container.background
                                                                                            {:id :background_role}
                                                                                            (ks.widget wibox.container.margin
                                                                                                       {:left 12
                                                                                                        :right 12}
                                                                                                       (ks.widget wibox.widget.textbox
                                                                                                                  {:id :text_role})))})
                                         (awful.widget.tasklist {: screen
